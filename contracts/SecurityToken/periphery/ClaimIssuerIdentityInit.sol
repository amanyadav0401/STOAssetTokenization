...
import "contracts/SecurityToken/periphery/IdentityInit.sol";

contract ClaimIssuerIdentityInit is IClaimIssuer, IdentityInit {
    ...
    function revokeClaim(bytes32 _claimId, address _identity) public override returns(bool) {
        ...
        ( foundClaimTopic, scheme, issuer, sig, data, ) = IdentityInit(_identity).getClaim(_claimId);
